...
def generate_launch_description():
  ...
  # TODO: actually default_bf_description_launch_dir is not needed
  default_bf_description_launch_dir = os.path.join(pkg_bf_description_share, 'launch')
  default_model_path = os.path.join(default_bf_description_launch_dir, 'urdf/bigfootbot.urdf')
